...
find_library(RCCL_LIBRARY_PATH_PATH
  NAMES ${RCCL_LIBNAME}
  HINTS
  ${RCCL_LIB_DIR}
  ${RCCL_ROOT_DIR}/lib)
...
find_package_handle_standard_args(RCCL DEFAULT_MSG RCCL_INCLUDE_DIR RCCL_LIBRARY_PATH_PATH)
...
if (RCCL_FOUND)
  ...
  set(RCCL_LIBRARIES ${RCCL_LIBRARY_PATH_PATH})
