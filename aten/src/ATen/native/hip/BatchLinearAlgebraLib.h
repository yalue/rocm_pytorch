...
void lu_solve_batched_cublas(const Tensor& b, const Tensor& lu, const Tensor& pivots, rocblas_operation trans);
...
void lu_solve_looped_cusolver(const Tensor& b, const Tensor& lu, const Tensor& pivots, rocblas_operation trans);
