...
#define CUDABLAS_GEQRF_BATCHED_ARGTYPES(Dtype)                   \
  rocblas_handle handle, int m, int n, Dtype **A_array, int lda, \
...
#define CUDABLAS_GELS_BATCHED_ARGTYPES(Dtype)  \
  rocblas_handle handle, rocblas_operation trans, int m, int n, int nrhs, Dtype** dA_array, int ldda, Dtype** dC_array, int lddc, int* info, int *devInfoArray, int batchSize
