...
#if defined(USE_ROCM) || ((defined(TORCH_HIP_VERSION) && TORCH_HIP_VERSION < 10000) || (defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 700)))
...
#if defined(TORCH_HIP_VERSION) && defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 600 || TORCH_HIP_VERSION < 8000)
...
#elif defined(USE_ROCM) || !(defined(__CUDA_ARCH__) && (defined(TORCH_HIP_VERSION) && TORCH_HIP_VERSION < 8000))
