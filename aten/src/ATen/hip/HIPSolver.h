...
#define CUDASOLVER_GETRS_ARGTYPES(Dtype)  \
    cusolverDnHandle_t handle, int n, int nrhs, Dtype* dA, int lda, int* ipiv, Dtype* ret, int ldb, int* info, rocblas_operation trans
...
#define CUDASOLVER_POTRF_ARGTYPES(Dtype)  \
    cusolverDnHandle_t handle, rocblas_fill uplo, int n, Dtype* A, int lda, Dtype* work, int lwork, int* info
...
#define CUDASOLVER_POTRF_BUFFERSIZE_ARGTYPES(Dtype)  \
    cusolverDnHandle_t handle, rocblas_fill uplo, int n, Dtype* A, int lda, int* lwork
...
#define CUDASOLVER_POTRF_BATCHED_ARGTYPES(Dtype)  \
    cusolverDnHandle_t handle, rocblas_fill uplo, int n, Dtype** A, int lda, int* info, int batchSize
...
#define CUDASOLVER_POTRS_ARGTYPES(Dtype)  \
    cusolverDnHandle_t handle, rocblas_fill uplo, int n, int nrhs, const Dtype *A, int lda, Dtype *B, int ldb, int *devInfo
...
#define CUDASOLVER_POTRS_BATCHED_ARGTYPES(Dtype)  \
    cusolverDnHandle_t handle, rocblas_fill uplo, int n, int nrhs, Dtype *Aarray[], int lda, Dtype *Barray[], int ldb, int *info, int batchSize
...
#define CUDASOLVER_ORMQR_BUFFERSIZE_ARGTYPES(Dtype)                          \
  cusolverDnHandle_t handle, rocblas_side side, rocblas_operation trans, \
...
template<class Dtype>
hipDataType_t get_cusolver_datatype() {
  TORCH_CHECK(false, "cusolver doesn't support data type ", typeid(Dtype).name());
}
template<> hipDataType_t get_cusolver_datatype<float>();
template<> hipDataType_t get_cusolver_datatype<double>();
template<> hipDataType_t get_cusolver_datatype<c10::complex<float>>();
template<> hipDataType_t get_cusolver_datatype<c10::complex<double>>();
...
#define CUDASOLVER_SYEVD_BUFFERSIZE_ARGTYPES(scalar_t, value_t)             \
  cusolverDnHandle_t handle, cusolverEigMode_t jobz, rocblas_fill uplo, \
...
#define CUDASOLVER_XSYEVD_BUFFERSIZE_ARGTYPES(scalar_t, value_t) \
  cusolverDnHandle_t handle, cusolverDnParams_t params,          \
      cusolverEigMode_t jobz, rocblas_fill uplo, int64_t n,  \
...
#define CUDASOLVER_XSYEVD_ARGTYPES(scalar_t, value_t)                        \
  cusolverDnHandle_t handle, cusolverDnParams_t params,                      \
      cusolverEigMode_t jobz, rocblas_fill uplo, int64_t n, scalar_t *A, \
